...
//            new QADataEntry("54", "(-1 / -3.2)").withMathTex("\\frac{-{1}}{-{3.2}}").withEvalRes(0.3125), // TODO: Regressed after checkIllegalOverlap
        ...
        QADataEntry[] entries_sigmaPiTerm = {
            new QADataEntry("sim_124", "Sigma((i = 1) : (8))(i)").withMathTex("\\sum\\limits_{{i}={1}}^{8}{i}").withEvalRes(36.0),     // Sigma sum term // TODO: Full sigma term
            new QADataEntry("sim_125", "Sigma((n = -2) : ((sqrt(4))))((n ^ 2))").withMathTex("\\sum\\limits_{{n}={-{2}}}^{\\sqrt{4}}{{n}^{2}}").withEvalRes(10.0)     // Sigma sum term // TODO: Full sigma term
        };
